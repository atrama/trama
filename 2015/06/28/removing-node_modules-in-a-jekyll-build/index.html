...
<!-- serving from GHPAGES -->
  ...
  <meta name="description" content="My Jekyll build recently slowed down dramatically. Like minutes to build versus a few seconds before. Since Jekyll relies on ruby to watch for changes, then ...">

  <link type="text/css" rel="stylesheet" href="/assets/main.css">
  <link rel="canonical" href="http://anthonytrama.com//2015/06/28/removing-node_modules-in-a-jekyll-build/">
  <link rel="alternate" type="application/rss+xml" title="Anthony Trama" href="http://anthonytrama.com//feed.xml">
</head>
  ...
  <header class="post-header">
    <h1 class="post-title" itemprop="name headline">Removing node_modules in a Jekyll build</h1>
    <p class="post-meta"><time datetime="June 28, 2015" itemprop="datePublished">June 28, 2015</time></p>
  </header>

  <div class="post-content" itemprop="articleBody">
    <p>My <a href="http://jekyllrb.com/">Jekyll</a> build recently slowed down dramatically. Like minutes to build versus a few seconds before. Since Jekyll relies on ruby to watch for changes, then compile all your files into a new _site folder, this made working virtually impossible.</p>
